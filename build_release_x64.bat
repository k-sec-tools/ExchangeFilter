...
"%msbuild2019%" ExchangeFilter.sln /nologo /v:minimal /p:Configuration=Release /p:Platform=x64 /p:AppendTargetFrameworkToOutputPath=false /target:Clean;Rebuild /nodeReuse:false /noWarn:1138;NETSDK1138;1701;NETSDK1701;NU1701;1702;NU1702;NETSDK1702
